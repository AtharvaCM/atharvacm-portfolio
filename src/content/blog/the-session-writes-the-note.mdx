...
The vault holds 638 notes across 86 commits. The weekly status update that used to be the most annoying twenty minutes of my week arrives as a draft I edit. The first time that task ran off its usual schedule, it worked out that its window was empty, wrote that there was therefore nothing new to report, and declined to pad. That is the behaviour you want from something writing on your behalf.
