...
context: Reporting and supply chain modules used across analytics and internal workflows.
...
impact: Easier extension, safer releases, and a bundle cut from roughly 7 MB to modular chunks.
metricHighlights:
