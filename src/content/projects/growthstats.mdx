...
title: Growthstats
slug: growthstats
excerpt: Built a CMS-powered Next.js platform with Sanity, including a page builder, publishing workflow, analytics instrumentation, and CI/CD automation.
...
impact: Teams could publish faster while keeping the platform structured, performant, and operationally simple to maintain.
metricHighlights:
...
coverImage: /images/projects/growthstats-homepage-screenshot.png
year: 2023
