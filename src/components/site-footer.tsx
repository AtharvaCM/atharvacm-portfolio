    ...
    <footer className="mt-24 pb-14 pt-10">
      <div className="shell">
        <div className="panel relative overflow-hidden px-6 py-10 md:px-10 md:py-12">
          <div className="pointer-events-none absolute -right-10 -top-12 h-40 w-40 rounded-full bg-accent/16 blur-3xl" />
          ...
          <div className="grid gap-10 md:grid-cols-[1.2fr_1fr_1fr] md:items-start">
            ...
            <div>
              <h3 className="text-xs uppercase tracking-[0.18em] text-text/60">Navigate</h3>
            ...
            <div>
              <h3 className="text-xs uppercase tracking-[0.18em] text-text/60">Elsewhere</h3>
              <ul className="mt-4 space-y-2 text-sm">
                {SOCIAL_LINKS.map((item) => (
                  <li key={item.href}>
                    <Link className="link-inline" href={item.href} rel="noreferrer" target="_blank">
                      {item.label}
                    </Link>
                  </li>
                ))}
          ...
          <p className="mt-5 text-xs uppercase tracking-[0.14em] text-text/55">Built with Next.js, MDX, and intentional motion.</p>
        </div>
      </div>
    </footer>
  );
