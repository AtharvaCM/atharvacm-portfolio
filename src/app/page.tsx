          ...
          <div className="mb-9 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm text-text/68">
                Case studies focused on interface quality, delivery ownership, and measurable product impact.
              </p>
            </div>
        ...
        <div className="panel relative overflow-hidden p-8 md:p-12">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div>
              ...
              <h2 className="section-heading mt-3 max-w-3xl">Exploring product engineering opportunities.</h2>
              <p className="mt-5 max-w-xl text-sm leading-relaxed text-text/72">
                If you think my experience aligns with your team, reach out and I will get back with availability.
              </p>
